...
# <<< NUEVO: importar el guardado de métricas de referencia
from src.monitoring.reference_metrics import save_reference_metrics
...
def run_gold_layer(cfg: Settings | None = None):
    ...
    # <<< NUEVO: guardar métricas de referencia del modelo final
    # Esto crea/actualiza el JSON que usará el drift_checker como baseline.
    save_reference_metrics(tuned_metrics_final, cfg)
    ...
    return {
        ...
        "xgb_tuned_metrics_final": tuned_metrics_final,  # <- este es el que se guarda
